   ...
   <div class="container-fluid min-vh-100 d-flex align-items-center"> 
        <div class="row w-100">
            ...
            <div class="col-lg-7 d-none d-lg-flex align-items-center justify-content-center pe-lg-5">
                ...
                <div>
                    <h1 class="fw-bold" style="font-size: 50px;">Magellan Solutions</h1>
                    <p class="fst-italic" style="font-size: 30px;">See The Future Your Way</p>
                </div>
            </div>

            
            <div class="col-lg-5 d-flex align-items-center justify-content-center ps-lg-5">
                <div class="card p-4 shadow-lg rounded-4 w-100" style="max-width: 400px; background-color: #515455;">
